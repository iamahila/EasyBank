...
import com.bank.accounts.dto.ErrorDTO;
...
public class CustomException extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleCustomerAlreadyExistsExceptions(CustomerAlreadyExists ex, WebRequest webRequest){
